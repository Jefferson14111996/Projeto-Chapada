...
export function ProfileModal({
  ...
  const wantsPwdChange = !!(currentPwd || newPwd || newPwd2);
  ...
  const save = () => {
    ...
    setProfile(email, {
      ...
      photoDataUrl: photo,
      ...(wantsPwdChange ? { password: newPwd } : {}),
    });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Atualize suas informações pessoais e, se desejar, sua senha.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="border-t pt-3">
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                />
                {wantsPwdChange && newPwd2.length > 0 && (
